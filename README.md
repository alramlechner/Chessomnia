...
- **Take back a move**, offer a draw, resign. A takeback restores the position *and* the
  clock in one step.
...
tools/           Generators for the wordmark, the piece drawables and the test corpus
...
| App icon | Original work | Apache-2.0 |
